...
<section class="error-404 clearfix">
    ...
    <div class="right-col">
        ...
        <p><?php _e( "We're sorry, but we can't find the page you were looking for. It's probably some things we've done wrong but now we know about it we'll try to fix it. In the meantime, try one of these options:", kopa_get_domain() ); ?></p>
        <ul class="arrow-list">
