...
define('KOPA_THEME_NAME', 'Ultra Mag');
define('KOPA_DOMAIN', 'ultra-mag');
define('KOPA_CPANEL_IMAGE_DIR', get_template_directory_uri() . '/library/images/layout/');
define('KOPA_UPDATE_TIMEOUT', 21600);
define('KOPA_UPDATE_URL', 'http://kopatheme.com/notifier/ultra-mag.xml');
...
function kopa_register_required_plugins() {
	$plugins = array(
		array(
			'name'     				=> 'Kopa Ultra Mag Shortcodes', // The plugin name
			'slug'     				=> 'kopa-ultra-mag-shortcodes', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/plugins/kopa-ultra-mag-shortcodes.zip', // The plugin source
		...
		array(
			'name'     => 'Woocommerce - a free eCommerce toolkit for WordPress',
			'slug'     => 'woocommerce',
			'required' => false,
		)
	);	
...
require get_template_directory() . '/woocommerce/woocommerce-config.php';