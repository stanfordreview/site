...
<h2></h2>
			...
			<h2 style="margin-top:30px;">Trackbacks</h2>

			<a href="<?php the_permalink(); ?>" rel="trackback" class="floated_link">Leave a Trackback</a>
	...
	<?php if (get_comment_type() != "comment"){ ?>
		...
		<div class="author_meta"><?php comment_author_link() ?> - <?php comment_date('j M Y') ?></div>
